...
class clearpage extends StatelessWidget {
  ...
  final List<String> posName = ["稲荷神社", "湯涌総湯中", "湯涌総湯外", "湯涌全体図"];

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Scrollbar(
        isAlwaysShown: true, // Scrollbarの表示
        child: SingleChildScrollView(
          child: Stack(
            children: <Widget>[
              Card(
                margin: EdgeInsets.symmetric(vertical: height / 52.0, horizontal: width / 11),
                child: Container(
                  width: width / 1.0,
                  height: height / 11.1,
              ...
              Card(
                margin: EdgeInsets.symmetric(vertical: height / 22.3, horizontal: width / 11),
                child: Container(
